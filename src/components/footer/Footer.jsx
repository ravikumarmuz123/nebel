    ...
    return (
        <footer id="site-footer">
            <div className="footer_contact_section container">
                ...
                <p className="text-center">Brauchen Sie Hilfe bei einer Anfrage, Bestellung oder haben Sie eine andere Frage? Nehmen Sie Kontakt mit uns auf!</p>
                <div className="footer-contact-banner">
                    <div className="row justify-content-center">
                        ...
                        <div className="col-lg-4 border-start border-end">
                            <div className="d-flex justify-content-center gap-3">
                                <div>
                        ...
                        <div className="col-lg-4">
                            <div className="d-flex justify-content-center gap-3">
                                <div>
                                    <h5 className="title mb-0">FAX</h5>
                                    <p className="mb-0">+43 (0) 1 58802 - 32</p>
                                </div>
                            </div>
                        </div>
                    </div>
